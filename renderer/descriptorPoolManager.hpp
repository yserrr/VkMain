...
std::vector<VkDescriptorSetLayout>* getLayouts() { return &layouts; }
std::array<VkDescriptorSet,3> getSets() { return descriptors;}
VkDescriptorSetLayout getVert() { return vertexLayout; }
VkDescriptorSetLayout getFrag() { return textureLayout;}
VkDescriptorSetLayout getLight(){ return lightLayout;  }
