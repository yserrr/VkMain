...
public:
//init for rendering
SceneRenderer(rendererCreateInfo info, Program path)
...
//나중에 scene받아서 rendering하도록 설정해야함
...
void setCamera    (Camera* cameraP)  { camera = cameraP; }
VkPipelineLayout getPipelineLayout(){ return pipeline_layout_h ; }
private:
//render resource::
